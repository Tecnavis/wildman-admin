          ...
          <div className="container">
            ...
            <input
                ...
                onChange={
                  ...
                  : (e) => setCoverimage(e.target.files[0])// Set the new cover image file
                }
        ...
        <div key={index} className="mt-2">
          ...
          />
              ...
              <div className="col-md-3 mb-3">
                <label>Color</label>
                <select
                  className="form-select" // Using Bootstrap form-select class for consistent dropdown styling
                  id="color"
                  name="color"
                  value={color}
                  onChange={(e) => {
                    ...
                    <div className="mb-2">
                      {imageFiles[colorKey].map((file, index) => (
                        <span key={index} className="badge bg-secondary me-2">
                          {file.name}
                        </span> // Display image names as badges
                      ))}
                    </div>
